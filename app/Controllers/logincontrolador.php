	...
	class loginControlador extends loginModelo{
		...
		public function iniciar_sesion_controlador(){
			...
			if($datos_cuenta->rowCount()==1){
				...
				return header("Location: ".'http://localhost/appSil_ci4/public/'."home/");
			}else{
				echo '
				<script>
					Swal.fire({
		...
		public function forzar_cierre_sesion_controlador(){
			...
			session_destroy();
			if(headers_sent()){
				return "<script> window.location.href='".'http://localhost/appSil_ci4/public/'."login/'; </script>";
			}else{
				return header("Location: ".'http://localhost/appSil_ci4/public/'."login/");
			}
		} /* Fin controlador */
		...
		public function cerrar_sesion_controlador(){
			...
			if($token==$_SESSION['token_spm'] && $usuario==$_SESSION['usuario_spm']){
				...
				$alerta=[
					...
					"URL"=>'http://localhost/appSil_ci4/public/'."login/"
				];
			}else{
				$alerta=[
					"Alerta"=>"simple",
